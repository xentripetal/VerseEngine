...
public class Window : IDisposable
{
	...
	private Action<uint, uint> SizeChangeCallback;
	...
	///     Note that you are responsible for recreating any graphics resources that need to change as a result of the size
	///     change.
	/// </summary>
	...
	{
		lock (IDToWindow) {
			return IDToWindow.TryGetValue(windowID, out var value) ? value : null;
		}
	}
	...
	/// </summary>
	public void RegisterSizeChangeCallback(Action<uint, uint> sizeChangeCallback)
	{
