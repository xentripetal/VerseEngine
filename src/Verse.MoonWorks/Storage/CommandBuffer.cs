...
///     Each operation gives you back a ResultToken that you can check to obtain the status of the operation and the
///     resulting data.
...
internal struct GetFileSizeCommand
{
	public IntPtr Path; // marshalled!
	public int PathLength;
}

internal struct ReadFileCommand
{
	public IntPtr Path; // marshalled!
	public int PathLength;
}

internal struct WriteFileCommand
{
	public IntPtr Path; // marshalled!
	public int PathLength;
