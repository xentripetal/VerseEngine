...
public class UserStorage : IDisposable
{
	...
	private readonly BlockingCollection<CommandBuffer> PendingCommandBuffers = [];
	private readonly Thread Thread;

	private bool IsDisposed;

	internal ResultTokenPool ResultTokenPool = new ResultTokenPool();
	...
	/// </summary>
	public CommandBuffer AcquireCommandBuffer() => CommandBufferPool.Obtain();
