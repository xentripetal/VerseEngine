...
public class Keyboard
{
	...
	private static readonly char[] TextInputCharacters = new[] {
		(char)2,   // Home
		(char)3,   // End
		(char)8,   // Backspace
		(char)9,   // Tab
	...
	/// </summary>
	public bool IsPressed(KeyCode keycode) => Keys[(int)keycode].IsPressed;

	/// <summary>
	///     True if the button was pressed this frame and the previous frame.
	/// </summary>
	public bool IsHeld(KeyCode keycode) => Keys[(int)keycode].IsHeld;

	/// <summary>
	///     True if the button was either pressed or continued to be held this frame.
	/// </summary>
	public bool IsDown(KeyCode keycode) => Keys[(int)keycode].IsDown;

	/// <summary>
	///     True if the button was let go this frame.
	/// </summary>
	public bool IsReleased(KeyCode keycode) => Keys[(int)keycode].IsReleased;

	/// <summary>
	///     True if the button was not pressed this frame or the previous frame.
	/// </summary>
	public bool IsIdle(KeyCode keycode) => Keys[(int)keycode].IsIdle;

	/// <summary>
	///     True if the button was either idle or released this frame.
	/// </summary>
	public bool IsUp(KeyCode keycode) => Keys[(int)keycode].IsUp;

	/// <summary>
	///     Gets a reference to a keyboard button object using a key code.
	/// </summary>
	public KeyboardButton Button(KeyCode keycode) => Keys[(int)keycode];

	/// <summary>
	///     Gets the state of a keyboard button from a key code.
	/// </summary>
	public ButtonState ButtonState(KeyCode keycode) => Keys[(int)keycode].State;
}