...
public class Mouse
{
	...
	/// </summary>
	public MouseButton Button(MouseButtonCode buttonCode) => CodeToButton[buttonCode];

	/// <summary>
	///     Gets a button state from a mouse button corresponding to the given MouseButtonCode.
	/// </summary>
	public ButtonState ButtonState(MouseButtonCode buttonCode) => CodeToButton[buttonCode].State;
