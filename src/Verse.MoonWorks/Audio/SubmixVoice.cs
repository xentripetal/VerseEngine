...
///     Therefore submixes early in a chain should have a low processingStage, and later in the chain they should have a
///     higher one.
/// </summary>
public class SubmixVoice : Voice
{
	...
	internal static SubmixVoice CreateFauxMasteringVoice(AudioDevice device) => new SubmixVoice(device);
}