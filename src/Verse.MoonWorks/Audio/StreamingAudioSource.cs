...
public abstract class StreamingAudioSource : AudioResource
{
	...
	protected StreamingAudioSource(AudioDevice device) : base(device) { }
	...
	{
		if (SendVoice != null) {
			var buffersNeeded = BUFFER_COUNT - (int)SendVoice.BuffersQueued; // don't get got by uint underflow!
