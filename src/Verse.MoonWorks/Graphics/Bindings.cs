...
{
	public static implicit operator TransferBufferLocation(TransferBuffer transferBuffer) => new TransferBufferLocation {
		TransferBuffer = transferBuffer,
		Offset = 0
	};
}
...
public struct BufferRegion
{
	...
	public static implicit operator BufferRegion(Buffer buffer) => new BufferRegion {
		Buffer = buffer,
		Offset = 0,
		Size = buffer.Size
	};
...
public struct VertexBufferDescription
{
	...
	public static VertexBufferDescription Create<T>(
		...
		uint stepRate = 0
	) where T : unmanaged => new VertexBufferDescription {
		Slot = slot,
...
[StructLayout(LayoutKind.Sequential)]
public unsafe struct INTERNAL_ShaderCreateInfo
{
...
[StructLayout(LayoutKind.Sequential)]
public unsafe struct INTERNAL_ComputePipelineCreateInfo
{
	public UIntPtr CodeSize;
	public byte* Code;
	public byte* EntryPoint;
...
public static partial class SDL_GPU
{
	...
	[LibraryImport(nativeLibName, StringMarshalling = StringMarshalling.Utf8)]
	[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	[return: MarshalUsing(typeof(SDL.SDLOwnedStringMarshaller))]
...
internal static partial class IRO
{
	...
	private const string nativeLibName = "IRO";
...
internal static partial class SDL_ShaderCross
{
	...
	public static VertexElementFormat FromIOVarType(IOVarType type, uint vectorSize)
	{
		return type switch {
			IOVarType.Int8 =>
				vectorSize switch {
