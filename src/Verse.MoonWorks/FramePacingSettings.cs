...
/// <summary>
///     The Game's frame pacing settings. Specifies uncapped framerate or a maximum rendering frames per second value.
///     <br />
/// </summary>
public struct FramePacingSettings
{
	...
	///     If Mode is set to LatencyOptimized, this value will be ignored and Game.Draw will run at the same rate as
	///     Game.Update.
	/// </summary>
