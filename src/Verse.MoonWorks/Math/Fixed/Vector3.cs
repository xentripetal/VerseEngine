...
public struct Vector3 : IEquatable<Vector3>
{
	...
	/// <returns><c>true</c> if the instances are equal; <c>false</c> otherwise.</returns>
	public bool Equals(Vector3 other) => X == other.X &&
	                                     Y == other.Y &&
	                                     Z == other.Z;
	...
	public static Vector3 Clamp(Vector3 value1, Vector3 min, Vector3 max) => new Vector3(
	...
	public static Vector3 ClampMagnitude(
		Vector3 value,
		Fix64 maxLength
	) => value.LengthSquared() > maxLength * maxLength ? Normalize(value) * maxLength : value;
	...
	public static Fix64 DistanceSquared(Vector3 value1, Vector3 value2) => (value1.X - value2.X) * (value1.X - value2.X) +
	...
	public static Fix64 Dot(Vector3 vector1, Vector3 vector2) => vector1.X * vector2.X + vector1.Y * vector2.Y + vector1.Z * vector2.Z;
	...
	public static Vector3 Normalize(Vector3 value)
	{
		...
		var factor = Fix64.One / Fix64.Sqrt(lengthSquared);
		return new Vector3(
			value.X * factor,
			value.Y * factor,
			value.Z * factor
	...
	/// <returns><c>true</c> if the instances are equal; <c>false</c> otherwise.</returns>
	public static bool operator ==(Vector3 value1, Vector3 value2) => value1.X == value2.X &&
	                                                                  value1.Y == value2.Y &&
	                                                                  value1.Z == value2.Z;
