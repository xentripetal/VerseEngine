...
public struct Vector2 : IEquatable<Vector2>
{
	...
	public override bool Equals(object obj) => obj is Vector2 fixVector && Equals(fixVector);
	...
	/// <returns><c>true</c> if the instances are equal; <c>false</c> otherwise.</returns>
	public bool Equals(Vector2 other) => X == other.X &&
	                                     Y == other.Y;
	...
	/// </summary>
	public Vector2 Truncated() => new Vector2((int)X, (int)Y);
	...
	public static Vector2 Lerp(Vector2 value1, Vector2 value2, Fix64 amount) => new Vector2(
	...
	public static Vector2 Clamp(Vector2 value1, Vector2 min, Vector2 max) => new Vector2(
	...
	public static Fix64 Dot(Vector2 value1, Vector2 value2) => value1.X * value2.X + value1.Y * value2.Y;
	...
	public static Vector2 Normalize(Vector2 value)
	{
		...
		var val = Fix64.One / Fix64.Sqrt(lengthSquared);
		value.X *= val;
		value.Y *= val;
		return value;
	}
	...
	{
		Vector2 result;
		var val = new Fix64(2) * (vector.X * normal.X + vector.Y * normal.Y);
	...
	public static Vector2 Rotate(Vector2 vector, Fix64 angle) => new Vector2(
	...
	/// <returns><c>true</c> if the instances are equal; <c>false</c> otherwise.</returns>
	public static bool operator ==(Vector2 value1, Vector2 value2) => value1.X == value2.X &&
	                                                                  value1.Y == value2.Y;
