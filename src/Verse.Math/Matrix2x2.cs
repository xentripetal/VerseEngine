...
public struct Matrix2x2 : IEquatable<Matrix2x2>
{
	...
	/// </summary>
	public static Matrix2x2 Identity { get; } = new (1f, 0f, 0f, 1f);

	/// <summary>
	///     Returns the zero matrix.
	/// </summary>
	public static Matrix2x2 Zero { get; } = new (0f, 0f, 0f, 0f);
	...
	public Vector2 Scale {
		get => new (XAxis.Length() * float.Sign(Determinant()), YAxis.Length());
		set {
			var oldScale = Scale;
	...
	public Matrix2x2(Vector2 scale, float radians)
	{
	...
	/// <summary>
	///     Creates a new <see cref="Matrix2x2" /> which contains sum of two matrixes.
	/// </summary>
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static void Add(ref Matrix2x2 matrix1, ref Matrix2x2 matrix2, out Matrix2x2 result)
	{
	...
	/// <summary>
	///     Creates a new rotation <see cref="Matrix2x2" /> around Z axis.
	/// </summary>
	/// <param name="radians">Angle in radians.</param>
	/// <returns>The rotation <see cref="Matrix2x2" /> around Z axis.</returns>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	...
	/// </summary>
	/// <param name="radians">Angle in radians.</param>
	/// <param name="result">The rotation <see cref="Matrix2x2" /> around Z axis as an output parameter.</param>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static void CreateRotation(float radians, out Matrix2x2 result)
	{
		result = Identity;
	...
	/// <summary>
	///     Creates a new scaling <see cref="Matrix2x2" />.
	/// </summary>
	/// <param name="scale">Scale value for all three axises.</param>
	/// <returns>The scaling <see cref="Matrix2x2" />.</returns>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	...
	/// </summary>
	/// <param name="scale">Scale value for all three axises.</param>
	/// <param name="result">The scaling <see cref="Matrix2x2" /> as an output parameter.</param>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static void CreateScale(float scale, out Matrix2x2 result)
	{
		CreateScale(scale, scale, out result);
	}
	...
	/// <param name="result">The scaling <see cref="Matrix2x2" /> as an output parameter.</param>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static void CreateScale(float xScale, float yScale, out Matrix2x2 result)
	{
	...
	/// <param name="result">The scaling <see cref="Matrix2x2" /> as an output parameter.</param>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static void CreateScale(ref Vector2 scale, out Matrix2x2 result)
	{
	...
	/// <summary>
	///     Divides the elements of a <see cref="Matrix2x2" /> by the elements of another matrix.
	/// </summary>
	/// <param name="matrix1">Source <see cref="Matrix2x2" />.</param>
	/// <param name="matrix2">Divisor <see cref="Matrix2x2" />.</param>
	/// <returns>The result of dividing the matrix.</returns>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Matrix2x2 Divide(Matrix2x2 matrix1, Matrix2x2 matrix2)
	{
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static void Divide(ref Matrix2x2 matrix1, ref Matrix2x2 matrix2, out Matrix2x2 result)
	{
		result.XAxis.X = matrix1.XAxis.X / matrix2.XAxis.X;
		result.XAxis.Y = matrix1.XAxis.Y / matrix2.XAxis.Y;
	...
	/// <summary>
	///     Divides the elements of a <see cref="Matrix2x2" /> by a scalar.
	/// </summary>
	/// <param name="matrix1">Source <see cref="Matrix2x2" />.</param>
	/// <param name="divider">Divisor scalar.</param>
	/// <returns>The result of dividing a matrix by a scalar.</returns>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Matrix2x2 Divide(Matrix2x2 matrix1, float divider)
	{
		var num = 1f / divider;
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static void Divide(ref Matrix2x2 matrix1, float divider, out Matrix2x2 result)
	{
		var num = 1f / divider;
	...
	/// <summary>
	///     Creates a new <see cref="Matrix2x2" /> that contains linear interpolation of the values in specified matrixes.
	/// </summary>
	/// <param name="matrix1">The first <see cref="Matrix2x2" />.</param>
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static void Lerp(ref Matrix2x2 matrix1, ref Matrix2x2 matrix2, float amount, out Matrix2x2 result)
	{
	...
	/// <summary>
	///     Creates a new <see cref="Matrix2x2" /> that contains a multiplication of two matrix.
	/// </summary>
	/// <param name="matrix1">Source <see cref="Matrix2x2" />.</param>
	/// <param name="matrix2">Source <see cref="Matrix2x2" />.</param>
	...
	public static void Multiply(in Matrix2x2 matrix, in Vector2 vec, out Vector2 result)
	{
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static void Multiply(in Matrix2x2 matrix1, in Matrix2x2 matrix2, out Matrix2x2 result)
	{
		var m11 = matrix1.XAxis.X * matrix2.XAxis.X + matrix1.XAxis.Y * matrix2.YAxis.X;
		var m12 = matrix1.XAxis.X * matrix2.XAxis.Y + matrix1.XAxis.Y * matrix2.YAxis.Y;
	...
	/// <summary>
	///     Creates a new <see cref="Matrix2x2" /> that contains a multiplication of <see cref="Matrix2x2" /> and a scalar.
	/// </summary>
	/// <param name="matrix1">Source <see cref="Matrix2x2" />.</param>
	/// <param name="scaleFactor">Scalar value.</param>
	/// <returns>Result of the matrix multiplication with a scalar.</returns>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Matrix2x2 Multiply(Matrix2x2 matrix1, float scaleFactor)
	{
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static void Multiply(ref Matrix2x2 matrix1, float scaleFactor, out Matrix2x2 result)
	{
	...
	///     Adds two matrixes.
	/// </summary>
	/// <param name="matrix1">Source <see cref="Matrix2x2" /> on the left of the add sign.</param>
	/// <param name="matrix2">Source <see cref="Matrix2x2" /> on the right of the add sign.</param>
	...
	/// <summary>
	///     Divides the elements of a <see cref="Matrix2x2" /> by the elements of another <see cref="Matrix2x2" />.
	/// </summary>
	/// <param name="matrix1">Source <see cref="Matrix2x2" /> on the left of the div sign.</param>
	/// <param name="matrix2">Divisor <see cref="Matrix2x2" /> on the right of the div sign.</param>
	...
	///     Divides the elements of a <see cref="Matrix2x2" /> by a scalar.
	/// </summary>
	/// <param name="matrix">Source <see cref="Matrix2x2" /> on the left of the div sign.</param>
	/// <param name="divider">Divisor scalar on the right of the div sign.</param>
	/// <returns>The result of dividing a matrix by a scalar.</returns>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Matrix2x2 operator /(Matrix2x2 matrix, float divider)
	{
		var num = 1f / divider;
	...
	/// <summary>
	///     Compares whether two <see cref="Matrix2x2" /> instances are equal without any tolerance.
	/// </summary>
	/// <param name="matrix1">Source <see cref="Matrix2x2" /> on the left of the equal sign.</param>
	/// <param name="matrix2">Source <see cref="Matrix2x2" /> on the right of the equal sign.</param>
	/// <returns><c>true</c> if the instances are equal; <c>false</c> otherwise.</returns>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static bool operator ==(Matrix2x2 matrix1, Matrix2x2 matrix2) => matrix1.XAxis == matrix2.XAxis &&
	                                                                        matrix1.YAxis == matrix2.YAxis;


	/// <summary>
	///     Compares whether two <see cref="Matrix2x2" /> instances are not equal without any tolerance.
	/// </summary>
	/// <param name="matrix1">Source <see cref="Matrix2x2" /> on the left of the not equal sign.</param>
	/// <param name="matrix2">Source <see cref="Matrix2x2" /> on the right of the not equal sign.</param>
	...
	/// </summary>
	/// <param name="matrix1">Source <see cref="Matrix2x2" /> on the left of the mul sign.</param>
	/// <param name="matrix2">Source <see cref="Matrix2x2" /> on the right of the mul sign.</param>
	/// <returns>Result of the matrix multiplication.</returns>
	/// <remarks>
	...
	/// </summary>
	/// <param name="matrix">Source <see cref="Matrix2x2" /> on the left of the mul sign.</param>
	/// <param name="scaleFactor">Scalar value on the right of the mul sign.</param>
	/// <returns>Result of the matrix multiplication with a scalar.</returns>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Matrix2x2 operator *(Matrix2x2 matrix, float scaleFactor)
	{
	...
	/// <summary>
	///     Subtracts the values of one <see cref="Matrix2x2" /> from another <see cref="Matrix2x2" />.
	/// </summary>
	/// <param name="matrix1">Source <see cref="Matrix2x2" /> on the left of the sub sign.</param>
	/// <param name="matrix2">Source <see cref="Matrix2x2" /> on the right of the sub sign.</param>
	...
	/// <summary>
	///     Inverts values in the specified <see cref="Matrix2x2" />.
	/// </summary>
	/// <param name="matrix">Source <see cref="Matrix2x2" /> on the right of the sub sign.</param>
	...
	/// <summary>
	///     Creates a new <see cref="Matrix2x2" /> that contains subtraction of one matrix from another.
	/// </summary>
	/// <param name="matrix1">The first <see cref="Matrix2x2" />.</param>
	/// <param name="matrix2">The second <see cref="Matrix2x2" />.</param>
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static void Subtract(ref Matrix2x2 matrix1, ref Matrix2x2 matrix2, out Matrix2x2 result)
	{
		result.XAxis.X = matrix1.XAxis.X - matrix2.XAxis.X;
		result.XAxis.Y = matrix1.XAxis.Y - matrix2.XAxis.Y;
	...
	/// <returns>The new <see cref="Matrix2x2" /> which contains the transposing result.</returns>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	...
	/// </summary>
	/// <param name="matrix">The matrix for transposing operation.</param>
	/// <param name="result">The new <see cref="Matrix2x2" /> which contains the transposing result as an output parameter.</param>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    #region Object
	/// <summary>
	///     Compares whether current instance is equal to specified <see cref="Matrix2x2" /> without any tolerance.
	/// </summary>
	/// <param name="other">The <see cref="Matrix2x2" /> to compare.</param>
	/// <returns><c>true</c> if the instances are equal; <c>false</c> otherwise.</returns>
	...
	/// <summary>
	///     Gets the hash code of this <see cref="Matrix2x2" />.
	/// </summary>
	/// <returns>Hash code of this <see cref="Matrix2x2" />.</returns>
	...
	public static Matrix2x2 Create(float radians, Vector2 scale)
	{
		Matrix2x2 result;
	...
	public static void Create(float radians, Vector2 scale, out Matrix2x2 result)
	{
