...
public static class Profiler
{
		...
		[CallerMemberName] string memberName = null)
	{
		...
		var srcLocId =
			TracyAllocSrclocName((uint)lineNumber, filestr, fileln, memberstr, memberln, namestr, nameln);
	...
	public static void PlotConfig(
		string name, PlotType type = PlotType.Number, bool step = false, bool fill = true,
		uint color = 0)
	{
#if PROFILING
