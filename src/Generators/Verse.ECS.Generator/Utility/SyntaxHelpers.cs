...
public static class SyntaxHelpers
{
	...
	public static List<MethodDeclarationSyntax> MethodsMatching(
		this TypeDeclarationSyntax declaration,
	...
	public static AttributeSyntax GetNamedAttribute(
		this MethodDeclarationSyntax node, string attributeName,
		CancellationToken cancel = default)
	{
