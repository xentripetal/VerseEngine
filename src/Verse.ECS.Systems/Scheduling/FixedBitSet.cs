...
public struct FixedBitSet : IEquatable<FixedBitSet>, IEnumerable<ulong>
{
	...
	public void EnsureCapacity(int capacity)
	{
		if (capacity > Capacity) {
			...
			var newInts = new int[GetInt32ArrayLengthFromBitLength((int)targetCapacity)];
			Data.CopyTo(newInts, 0);
			var newData = new BitArray(newInts);
			Data = newData;
			Capacity = (int)Data.Length;
		}
	}
	...
	public bool Equals(FixedBitSet other)
	{
		if (Length != other.Length)
			return false;
		return !((BitArray)Data.Clone()).Xor(other.Data).HasAnySet();
	}
	...
	public override int GetHashCode() => HashCode.Combine(Data, Capacity, Length);
