...
{
	private readonly Dictionary<EcsID, EcsID> _childrenToParent = new Dictionary<EcsID, EcsID>();
	private readonly Dictionary<EcsID, List<EcsID>> _parentsToChildren = new Dictionary<EcsID, List<EcsID>>();
	...
	{
		_childrenToParent.TryGetValue(childId, out var parentId);
		return parentId;
	}
...
{
	private readonly Dictionary<EcsID, string> _entitiesWithName = new Dictionary<EcsID, string>();
	private readonly Dictionary<string, EcsID> _names = new Dictionary<string, EcsID>();
	private readonly World _world;
