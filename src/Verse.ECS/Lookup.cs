...
internal static class Lookup
{
	...
	private static readonly FastIdLookup<Func<int, Array?>> _arrayCreator = new FastIdLookup<Func<int, Array?>>();
	private static readonly FastIdLookup<ComponentInfo> _components = new FastIdLookup<ComponentInfo>();
	...
	internal static class Component<T> where T : struct
	{
		...
		public static readonly ulong HashCode = (ulong)Interlocked.Increment(ref _index);
